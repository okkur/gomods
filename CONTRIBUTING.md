...
Thank you for your interest in contributing to Gomods.  
This guide helps make contributing to Gomods simple and efficient for everyone.

### First contribution

If you are starting out contributing to Gomods, there might be smaller scoped "starter issues" available:
[Current starter issues](https://github.com/okkur/gomods/labels/starter%20issue)
...
As your time is precious and not all features might be in the scope of what the Gomods wants to achieve, please open up an issue first.
